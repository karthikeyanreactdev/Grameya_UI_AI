...
import { editCertificationSeeker } from "src/api-services/seeker/profile";
...
const EditCertification = ({
  ...
  const handleFormSubmit = async () => {
    ...
    const apiDate = formValue;
    apiDate.id = selectedCertificate.id;
